...
const ListItem: React.FC<ListItemProps> = ({ image, name, href }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute transition-all opacity-0 rounded-full flex items-center justify-center bg-green-500 p-3 drop-shadow-md right-5 group-hover:opacity-100 hover: scale-110">
